...
<div class="wrap">     
	...
	<c:if test="${!empty selectBoard.boardnum}">
	<form action="updateBoard" method="post" id="boardWriteForm" enctype="multipart/form-data">
	<input type="hidden" name="clickNo" value="${clickNo}">
 	</c:if>
	<input type="hidden" id="form_id" name="id" value="${selectProposal.id}${selectBoard.id}">
	<input type="hidden" id="form_proposalnum" name="proposalnum" value="${selectProposal.proposalnum}${selectBoard.boardnum}">
	<input type="hidden" id="form_membertype" name="membertype" value="${selectProposal.membertype}${selectBoard.membertype}">
	<input type="hidden" id="form_title" name="title" value="${selectProposal.title}${selectBoard.title}">
	<input type="hidden" id="form_comments" name="comments" value="${selectProposal.comments}${selectBoard.comments}">
	<input type="hidden" id="form_precaution" name="precaution" value="${selectProposal.precaution}${selectBoard.precaution}">
	<input type="hidden" id="form_offday" name="offday" value="${selectProposal.offday}${selectBoard.offday}">
	...
	<input type="hidden" id="form_scale" name="scale" value="${selectProposal.scale}${selectBoard.scale}">
	<input type="hidden" id="form_spaceaddr1" name="spaceaddr1" value="${selectProposal.spaceaddr1}${selectBoard.spaceaddr1}">
	<input type="hidden" id="form_spaceaddr2" name="spaceaddr2" value="${selectProposal.spaceaddr2}${selectBoard.spaceaddr2}">
	<input type="hidden" id="form_latitude" name="latitude" value="${selectProposal.latitude}${selectBoard.latitude}">
	<input type="hidden" id="form_longitude" name="longitude" value="${selectProposal.longitude}${selectBoard.longitude}">
<div class="boardWriteContent">
	<h4>공고문 제목</h4><br>
	<span class="inputNorm"><input type="text" id="title" value="${selectProposal.title}${selectBoard.title}"></span>
	<div id="titleCheck" class="titleCheck"></div>
	<c:if test="${selectProposal.membertype=='공간제공자'||selectBoard.membertype=='공간제공자'}">
	<h4>공간이름</h4><br>
	<span class="inputNorm"><input type="text" id="name" value="${selectProposal.name}${selectBoard.name}"></span>
	<h4>공간소개</h4><br>
	<textarea rows="10" cols="100" id="comments">${selectProposal.comments}${selectBoard.comments}</textarea><br>
   	<h4>물품분류</h4><br>
    ...
    <div>
        ...
        <c:if test="${!empty selectBoard.boardnum}">
            <c:if test="${!empty contentDetail[0].image1}"><img class="img1" src="resources/images/userImage/${sessionMember.id}/board/${selectBoard.title}/${contentDetail[0].image1}"></c:if>
            <c:if test="${!empty contentDetail[0].image2}"><img class="img1" src="resources/images/userImage/${sessionMember.id}/board/${selectBoard.title}/${contentDetail[0].image2}"></c:if>
            <c:if test="${!empty contentDetail[0].image3}"><img class="img1" src="resources/images/userImage/${sessionMember.id}/board/${selectBoard.title}/${contentDetail[0].image3}"></c:if>
        </c:if>
        </div>
	...
	<h4>규모</h4><br>
	<span class="inputNorm"><input type="number" id="scale" step="any" value="${selectProposal.scale}${selectBoard.scale}"></span><br>
	...
	<div id="offdaySelected">
		<input type="hidden" id="offdayContent1" value="${contentDetail[0].offday1}">
		<input type="hidden" id="offdayContent2" value="${contentDetail[0].offday2}"><input type="hidden" id="offdayContent4" value="${contentDetail[0].offday4}">
		<input type="hidden" id="offdayContent3" value="${contentDetail[0].offday3}"><input type="hidden" id="offdayContent5" value="${contentDetail[0].offday5}">
		<input type="hidden" id="offdayContent6" value="${contentDetail[0].offday6}"><input type="hidden" id="offdayContent7" value="${contentDetail[0].offday7}">
	</div><br>
	...
	<h4>희망가격</h4><br>
	<span class="inputNorm"><input type="number" id="price" value="${selectProposal.price}${selectBoard.price}">원</span><br>
	<h4>현재재고상태</h4><br>
	<span class="inputNorm"><input type="number" id="stock" value="${selectProposal.stock}${selectBoard.stock}">개</span><br>
	<h4>계약기간</h4><font>계약기간은 여러개 선택 가능</font><br>
	<div class="contractPeriod">
	<ul class="ul-contractPeriod">
		<li class="li-contractPeriod"><span class="span-contractPeriod"><a href="javascript:void(0);" data-sno=1 id="contractPeriod1" class="contractPeriod-a"><i data-sno=1 id="contractPeriod-icon1" class="fas fa-check"></i>　1주</a></span></li>
